...
PASSWORD = "Omnibus1"
LOCAL_SCRIPT = "diag_games.py"
REMOTE_PATH = "~/football-prod/diag_games.py"
...
if __name__ == "__main__":
    ...
    run_remote_command(f"docker cp {REMOTE_PATH} football-prod_app_1:/app/diag_games.py")
    run_remote_command("docker exec football-prod_app_1 python3 diag_games.py")
