...
if __name__ == "__main__":
    LOCAL_SCRIPT = "force_calculate_mvp.py"
    REMOTE_PATH = "~/football-prod/force_calculate_mvp.py"
    upload_file(LOCAL_SCRIPT, REMOTE_PATH)
    
    print(">>> FORCING FINISH...")
    run_remote_command(f"docker cp {REMOTE_PATH} football-prod_app_1:/app/force_calculate_mvp.py")
    run_remote_command(f"docker exec -i football-prod_app_1 python3 /app/force_calculate_mvp.py")
