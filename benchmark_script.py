import asyncio
import time
from sqlalchemy import select, func, text, Column, Integer, String, BigInteger, ForeignKey, Enum as SQLEnum, Float, Boolean, ARRAY, DateTime
...
async def main():
    ...
    t_old = await benchmark_old()
    t_new = await benchmark_new()
